 ...
 * @author     Bruno blauzius  <bruno@criarsites.cc>
 * @copyright  2014 Bruno Blauzius
 * @version    1.2.0
...
class SitemapGenerator {
     ...
     */
    public function __construct($baseURL, $basePath = null) {
    ...
    public function createSitemap() {
        ...
        $generatorInfo = '<!-- generator="SimpleSitemapGenerator/'.$this->classVersion.'" -->
                          <!-- sitemap-generator-url="http://www.criarsites.cc"
